        ...
        <td>
          <ul class="action">
            <li class="employee-edit mx-2">
              <a href="edit-employee-weight-calculation.php?id=<?php echo urlencode($row['weight_id']); ?>">
                <i class="fa-solid fa-user-pen"></i>
              </a>
            </li>
            <li class="preview mx-2">
              <a href="preview-weight-calculation.php?id=<?php echo urlencode($row['weight_id']); ?>">
                <i class="fa-regular fa-eye"></i>
              </a>
            </li>
            <li class="edit">
              <a href="edit-weight-calculation.php?id=<?php echo urlencode($row['weight_id']); ?>">
        ...
        <div class="col-sm-6 col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="date" name="date"
              value="<?php echo ($_REQUEST['mode'] == 'edit') ? $date : date('Y-m-d'); ?>" readonly>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select class="form-select" id="supplier" name="supplier" required>
              ...
              <?php
              $sql = "SELECT * FROM weight WHERE status = '1' ORDER BY id DESC LIMIT 1";
      ...
      <div class="row mx-4 custom-gap">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="bag_batch" name="bag_batch"
              value="<?php echo $pvt_mark;?>" required>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="rate_per_kg" name="rate_per_kg"
              value="<?php echo $rate_per_kg;?>" required>
          </div>
        </div>
      </div>
      ...
      <div class="row mx-4 custom-gap">
        <div class="col-sm-6 col-md-6">
          <div class="form-group">
            ...
            <input type="text" name="desire_no_bag" class="form-control" id="fieldCount"
              oninput="handleKeyPress(this)" onkeyup="checkLotNumber(this)">
      ...
      <div class="row mx-4 custom-gap">
        <div class="col-sm-6 col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="grosswt" name="grosswt"
              value="<?php echo $gross_weight; ?>" readonly>
          </div>
        </div>
        <div class="col-sm-6 col-md-6">
          <div class="form-group">
            <label class="form-label">Gross Amount</label>
            <input type="text" class="form-control" id="gross_amount" name="grossamount"
              value="<?php echo $gross_weight; ?>" readonly>
          </div>
        </div>
      </div>
      ...
      <div class="row mx-4 custom-gap">
        <div class="col-md-6">
          <div class="form-group">
            ...
            ?>
            <input type="number" class="form-control" id="gunnies_bag_rate" name="gunnies_bag_rate"
        ...
        <div class="col-sm-6 col-md-6">
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="net_weight" name="net_weight"
              value="<?php echo $net_weight; ?>" readonly>
          </div>
        </div>
      </div>
      ...
      <div class="row mx-4 custom-gap">
        <div class="col-sm-6 col-md-6">
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="gunnies_bag_total" name="gunnies_bag_total"
              value="<?php echo $gunny_bag_total; ?>" readonly>
          </div>
        </div>
        <div class="col-sm-6 col-md-6">
          <div class="form-group">
...
function performCalculations() {
    let totalWeight = 0;
    let bagInputs = document.querySelectorAll(".bag-weight-input"); // Target the weight inputs by their class
    ...
    let grossAmount = totalWeight*ratePerKg;
    ...
    document.getElementById("grosswt").value = totalWeight.toFixed(2);  // Display gross weight
