...
if (!empty($_REQUEST['hid'])) {
    ...
    if ($_REQUEST['hid'] == 'add') {
        ...
        $sql = "INSERT INTO suppliers (supplier, shopname, mobile, address, gst, adhar,account) VALUES (?, ?, ?, ?, ?, ?, ?)";
        $result = mysqli_prepare($conn, $sql);

        if ($result) {
            mysqli_stmt_bind_param($result, "ssss", $supplier, $shopname, $mobile, $address);
...
if (isset($_SESSION['success_message']) && isset($_SESSION['flash_color'])) {
    ...
    echo '<script>
            setTimeout(function() {
                window.location.href = "manage-supplier.php"; // Change to your desired page
                               ...
                               <div class="table-responsive">
                                     <div class="mb-5">
                                            <button type="button" class="btn btn-success btn-icon-text " style="float:left"
                                                onclick="location.href='manage-supplier.php?mode=add'">
                              ...
                              <table class="display" id="basic-1">
                                ...
                                <?php
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <ul class="action"> 
                                                    <li class="edit"> <a href="manage-supplier.php?mode=edit&id=<?php echo $row['id'];?>"><i class="icon-pencil-alt"></i></a></li>
                                                    <li class="delete"><a href="manage-supplier.php?mode=delete&id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="icon-trash"></i></a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <?php 
