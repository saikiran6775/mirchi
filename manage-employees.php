<?php
// Start the session and set last visited page
session_start();
...
if (!isset($_SESSION['user_id'])) {
    header('Location: marchant-dashboard.php');
    exit();
}

// Handle soft delete (status = 'inactive')
...
// Get employee list for this page
                            ...
                            <div class="col-sm-6 col-12">
                                 <div class="m-3">
                                    <button type="button" class="btn btn-success btn-icon-text btn-sm "
                                        style="float:right; padding:5px;" onclick="location.href='manage-employee-profile.php?mode=add'">
                                    <i class="icon-plus"></i>
                                         Add Employee
                                    </button>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="social-img-wrap">
                                                <div class="social-img">
                                                   <img class="img-fluid" src="<?php echo !empty($row['profile_image']) ? htmlspecialchars($row['profile_image']) : 'upload/3.jpg'; ?>" alt="profile" width="70" />
                                                </div>
                                            </div>
                                            <div class="social-details">
                                                ...
                                                <ul class="social-follow">
                                                    ...
                                                    <li>
                                                         <ul class="action"> 
                                                            <li class="edit"> <a href="manage-employee-profile.php?mode=edit&id=<?php echo $row['id'];?>"><i class="icon-pencil-alt"></i></a></li>
                                                            <a href="manage-employees.php?mode=delete&id=<?= (int)$row['id']; ?>"
