...
if (isset($_REQUEST['submit'])) {
  ...
  $check_query = "SELECT * FROM merchants WHERE id = $id AND password = '$old_password'";
  ...
  if ($result->num_rows > 0) {
      ...
      $update_query = "UPDATE merchants SET password = '$new_password' WHERE id = $id";
...
<html lang="en">
  <head>
    ...
    <title>Mirchi CRM - Premium Merchant Template</title>
    <!-- Favicon icon-->
