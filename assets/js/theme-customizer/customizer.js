(function ($) {
    // Check for stored theme color preference
    ...
    // Handle color picker selection and saving to localStorage
    ...
    // Apply stored primary and secondary colors
    ...
    // Open and close the settings sidebar
    $(document).ready(function () {
        ...
        // Layout settings (LTR, RTL, Box Layout)
        document.querySelector(".ltr-setting").addEventListener("click", function () {
            document.body.classList.remove("rtl", "ltr", "box-layout", "dark-only");
            document.documentElement.setAttribute("dir", "ltr");
        });
        document.querySelector(".rtl-setting").addEventListener("click", function () {
            document.body.classList.remove("ltr", "rtl", "box-layout", "dark-only");
            document.documentElement.setAttribute("dir", "rtl");
        });
        document.querySelector(".box-setting").addEventListener("click", function () {
        ...
        document.querySelector(".colorfull-svg").addEventListener("click", function () {
        ...
        document.querySelectorAll(".default-svg").forEach(function (element) {
            element.addEventListener("click", function () {
                ...
                for (var i = 0; i < pageSidebarElements.length; i++) {
                    pageSidebarElements[i].setAttribute("data-sidebar-layout", "stroke-svg");
                    pageSidebarElements[i].classList.remove("iconcolor-sidebar");
                }
            });
        });

        // Handle horizontal and vertical sidebar settings
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (toggleDarkSidebarButton) {
            ...
            console.log(".mix-setting element not found.");
        }
    });

    /**==HORIZONTAL SIDEBAR ARROW SCROLL==**/
    ...
    var sliderLimit = menuWrapperSize >= "1660" ? -3250 : menuWrapperSize >= "1440" ? -3250 : -4500;

    $("#left-arrow").addClass("disabled");

    // Right arrow scroll functionality
    ...
    // Left arrow scroll functionality
